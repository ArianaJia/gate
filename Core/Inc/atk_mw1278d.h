...
#define ATK_MW1278D_AUX_GPIO_PIN            GPIO_PIN_7
#define ATK_MW1278D_AUX_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)
#define ATK_MW1278D_MD0_GPIO_PORT           GPIOA
#define ATK_MW1278D_MD0_GPIO_PIN            GPIO_PIN_6
#define ATK_MW1278D_MD0_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOA_CLK_ENABLE();   \
